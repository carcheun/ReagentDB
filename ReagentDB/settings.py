...
INSTALLED_APPS = [
    ...
    'users',            # users app so we can log in
    'oauth2_provider',  # ouath2 as our authorization package
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        # TODO: Personally protect each endpoint API or allow for authenticated users
